...
STM32G0_CFLAGS=$(M4FH_FLAGS) -DSTM32G4 -DLITTLE_BIT=400000 $(LFLAGS_STM32) -lopencm3_stm32g4
...
endef
define stm32g4board
	$(call MakeBoard,$(1),$(2),$(3),$(STM32G4_CFLAGS),stm32g4,$(4),$(5))
endef
define stm32h7board
...
# STM32G4 boards
$(eval $(call stm32g0board,nucleo-g474re,GPIOA,GPIO5))
